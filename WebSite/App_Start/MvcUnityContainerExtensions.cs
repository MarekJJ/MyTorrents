...
namespace WebSite.App_Start
{
    public static class MvcUnityContainerExtensions
    {
        ...
        public static void RegisterTypeWithDefaultConstructorPerRequest<TFrom, TTo>(this IUnityContainer unityContainer)  // to jest rozszerzenie dla public static void RegisterTypes(IUnityContainer container) znajdujące sie w unityConfig
            where TTo : TFrom
        {
